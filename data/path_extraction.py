...
def load_dicts():
    ...
    '''
    with open(r"song_data_vocab\song_person_ix.dict", 'rb') as handle:
        song_person = pickle.load(handle)

    with open(r"song_data_vocab\person_song_ix.dict", 'rb') as handle:
        person_song = pickle.load(handle)

    with open(r"song_user_ix.dict", 'rb') as handle:
        song_user = pickle.load(handle)

    with open(r"song_data_vocab\user_song_ix.dict", 'rb') as handle:
