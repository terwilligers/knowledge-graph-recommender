...
python release/data_prepare/path_find_depth_3.py $movie_person_dict_path $person_movie_dict_path $movie_type_dict_path $type_movie_dict_path \
...
python release/data_prepare/path_find_depth_5.py $movie_person_dict_path $person_movie_dict_path $movie_type_dict_path $type_movie_dict_path \
...
python3 release/data_prepare/clustering.py $depth_3_output_file_path $depth_3_clustering_path

#echo "depth 5 clustering..."
python3 release/data_prepare/clustering.py $depth_5_output_file_path $depth_5_clustering_path
